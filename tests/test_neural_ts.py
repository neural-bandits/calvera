...
# ------------------------------------------------------------------------------
# 1) Tests for NeuralTSBandit Forward Pass
# ------------------------------------------------------------------------------
def test_neural_ts_bandit_forward_shape() -> None:
    """
...
def test_neural_ts_bandit_forward_small_sample() -> None:
    """
...
# ------------------------------------------------------------------------------
# 2) Tests for updating the NeuralTS bandit
# ------------------------------------------------------------------------------
@pytest.fixture
def small_context_reward_batch() -> tuple[
    ...
    Returns (chosen_contextualized_actions, rewards, dataset):
      chosen_contextualized_actions shape: (batch_size=3, n_chosen_arms=1, n_features=4)
      rewards shape: (3,1)
    """
...
def test_neural_ts_bandit_training_step(
...
def test_neural_ts_bandit_hparams_effect() -> None:
    """
